...
public struct SubmissionResult: Codable {
    ...
    /// "stdout example
    /// "
    public var stdOutput: String
    /// Example:
    ///
    /// "[2,7,11,15]
    /// 9"
    public var lastTestcase: String
    /// Example: "[0,1]"
    ...
    public init(
        ...
        self.lastTestcase = lastTestcase
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.compareResult = try values.decode(String.self, forKey: "compare_result")
        self.stdOutput = try values.decode(String.self, forKey: "std_output")
        self.lastTestcase = try values.decode(String.self, forKey: "last_testcase")
        self.expectedOutput = try values.decode(String.self, forKey: "expected_output")
        self.inputFormatted = try values.decode(String.self, forKey: "input_formatted")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encode(compareResult, forKey: "compare_result")
        try values.encode(stdOutput, forKey: "std_output")
        try values.encode(lastTestcase, forKey: "last_testcase")
        try values.encode(expectedOutput, forKey: "expected_output")
        try values.encode(inputFormatted, forKey: "input_formatted")
